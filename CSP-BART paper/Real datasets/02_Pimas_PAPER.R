...
hybridy_hat_new = cl_predict_semibart(hybrid_new_semi_bart,aux_data_train_hybrid1,x_train,'mean')
hybridyhat_test = cl_predict_semibart(hybrid_new_semi_bart,aux_data_test_hybrid1,test_hybrid1,'mean')
...
y_hat_new_our_ssp = cl_predict_semibart(our_ssp_bart,aux_data_train,x_train,'mean')
yhat_test_our_ssp = cl_predict_semibart(our_ssp_bart,aux_data_test,x_test,'mean')
...
y_hat_new_our_ssp22 = cl_predict_semibart(our_ssp_bart22,aux_data_train,x_train22,'mean')
yhat_test_our_ssp22 = cl_predict_semibart(our_ssp_bart22,aux_data_test,x_test22,'mean')
